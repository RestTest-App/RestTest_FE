    ...
    return Obx(() {
      ...
      return Container(
          ...
          decoration: BoxDecoration(
              ...
              border:
                  Border(top: BorderSide(color: ColorSystem.grey.shade300))),
          child: Padding(
              ...
              children: [
                Expanded(
                  child: RoundedRectangleTextButton(
                      ...
                      onPressed:
                          hasPrev ? () => viewModel.prevQuestion() : null),
                ),
                const SizedBox(
                  width: 8,
                ),
            ...
            Column(
              ...
              children: [
                Wrap(spacing: 4.0, children: [
                  _buildTag(viewModel.reviewDetail?.exam.name ?? '시험명',
                      ColorSystem.lightBlue, ColorSystem.blue),
                  _buildTag(
                      '${viewModel.reviewDetail?.exam.year}년도 ${viewModel.reviewDetail?.exam.month}회',
                      ColorSystem.grey.shade200,
                      ColorSystem.grey.shade600),
                ]),
                const SizedBox(
                ...
                Wrap(
                  ...
                  children: [
                    _buildTag(
                      "${exam.passRate > 100 ? (exam.passRate / 100).toStringAsFixed(1) : exam.passRate.toStringAsFixed(1)} 점",
                      (exam.passRate > 100
                                  ? exam.passRate / 100
                                  : exam.passRate) >=
                              80.0
        ...
        child: Container(
          ...
          child: Center(
            child: Text(
              "문제이동",
              style:
                  FontSystem.KR12M.copyWith(color: ColorSystem.grey.shade600),
            ),
          ),
        ));
  }
      ...
      () => SizedBox(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // 색상 로직
              final bgColor = isCorrect ? ColorSystem.green : ColorSystem.red;
