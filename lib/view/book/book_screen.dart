...
class _FilterRow extends StatelessWidget {
  ...
  const _FilterRow({super.key, required this.controller});
...
class _FileGrid extends StatelessWidget {
  final BookViewModel controller;
  const _FileGrid({super.key, required this.controller});
...
class _AddNewFileTile extends StatelessWidget {
  final BookViewModel controller;
  const _AddNewFileTile({super.key, required this.controller});
...
class _FileTile extends StatelessWidget {
  ...
  const _FileTile({super.key, required this.file});
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Image.asset('assets/images/book_file.png',
