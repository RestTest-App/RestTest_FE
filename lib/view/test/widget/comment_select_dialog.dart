...
class CommentSelectDialog extends BaseWidget<TestViewModel> {
  const CommentSelectDialog({super.key});
    ...
    return Obx(() => Container(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final bool isCorrect = userAnswer != null && (userAnswer + 1 == correctAnswer);
